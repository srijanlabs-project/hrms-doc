...
document: 03-notification-framework.md
version: 1.1
status: Draft
---
...
This document defines the shared enterprise standard for `Notification Framework` across the Enterprise HRMS platform. It exists so that teams do not reinterpret the same foundational concern differently from module to module.
