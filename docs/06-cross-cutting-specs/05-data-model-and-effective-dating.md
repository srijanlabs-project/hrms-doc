...
document: 05-data-model-and-effective-dating.md
version: 1.1
status: Draft
---
...
This document defines the shared enterprise standard for `Data Model and Effective-Dating Standards` across the Enterprise HRMS platform. It exists so that teams do not reinterpret the same foundational concern differently from module to module.
