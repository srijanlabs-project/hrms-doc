...
import { CompanySetupController } from "./company-setup/company-setup.controller";
import { CompanySetupRepository } from "./company-setup/company-setup.repository";
...
@Module({
  ...
  controllers: [ImportBatchController, GoLiveChecklistController, BulkExportController, CompanySetupController],
  providers: [
    ImportEngineService,
    ImportBatchRepository,
    GoLiveChecklistService,
    GoLiveChecklistRepository,
    BulkExportService,
    CompanySetupService,
