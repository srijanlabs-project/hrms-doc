...
-- CreateIndex
CREATE UNIQUE INDEX "leave_policies_tenant_id_leave_type_key" ON "leave_policies"("tenant_id", "leave_type");
...
-- CreateIndex
CREATE INDEX "leave_requests_tenant_id_approver_id_idx" ON "leave_requests"("tenant_id", "approver_id");
